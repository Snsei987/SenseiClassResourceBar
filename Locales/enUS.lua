...
local baseLocale = {
    ...
    ["MAELSTORM"]= POWER_TYPE_MAELSTROM,
    ...
    ["SOUL_FRAGMENTS_VOIC_META"] = "Soul Fragments Void Meta.",
    ...
    ["RELATIVE_FRAME_CYLIC_WARNING"] = "Cannot change Relative Frame as the selected Frame is already relative to this Frame.",
